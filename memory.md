...
> **最后更新**：2026-06-09（前端按 docs/image 视觉基准接入 image2 水墨人物、山水和朱砂印资产，并修正 360px 移动端裁切）。
...
| 最近收口 | 2026-06-09 已在第二轮剩余页面纸面化基础上，用 image2 生成并落地统一水墨人物头像、山水书案背景和朱砂印装饰资产，接入 `VisualAssetPanel` 本地兜底、书架/锚定封面、墨色侧栏、世界锚定左栏、深层卷宗 hero、空态与设置组标题；同时修正世界书架标题、AppShell/WorldWorkspaceShell 移动端状态条和世界锚定阶段指标在 360px 下的裁切/溢出 |
