...
- 世界锚定页启动卡、最近阅读续航、世界卷宗总览、当前旅程状态与移动端保功能布局：天命书、世界沙盘和卷宗阅读在锚定首屏可见；阅读类路由会写入本机最近阅读记录，锚定页和 AppShell 世界位置条都可一键续读；锚定页把天命书、沙盘、阅读、世界线、多视角、作者台和机制档案串成可点击世界内地图，并用“下一步/可用/待生成”提示用户当前该确认天命、进入阅读还是继续续读；窄屏不再隐藏视觉/审计/角色功能。
