...
- 世界书架入口：首屏已有推荐世界面板，按导入优先、已有沙盘结果次之、原顺序兜底选择最该进入的世界，展示推荐理由、阶段、来源、世界线运行数和主动作；故事卡会按运行次数和来源显示当前阶段、推荐下一步、来源和世界线运行数；未运行世界推荐确认天命，已有沙盘结果推荐进入卷宗阅读，同时保留世界沙盘、天命书、卷宗阅读、作者采纳台和机制档案入口。
