...
- 卷宗阅读页：默认连续阅读，卷首题签解释当前阅读卷、偏差/悬念、证据数和下一步行动；连续正文按场景呈现阅读进度、认知偏差、冲突转折和段内证据锚点；正文上方有当前场景导读条，可上一场/下一场、看证据和追误会；误会图谱可点击定位正文场景或卷宗视角；正文和关联卷宗之后有“读完之后”余波承接台，可回看误会、追长线、继续沙盘或送作者台；移动端首屏有“开始读正文 / 查卷宗 / 作者台”导读条，用户可直接进入正文、卷宗目录或续写台。
