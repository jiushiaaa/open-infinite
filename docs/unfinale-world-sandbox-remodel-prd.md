...
- AppShell 世界位置条、体验轨道与全局续读：所有世界内路由都会在顶栏下方显示“当前位置”、页面职责、主动作/次动作，以及“定界 / 运行 / 阅读 / 采纳”四段可点击世界轨道；同一世界已有最近阅读记录时，位置条会在用户不在该阅读位置时提供“继续阅读”，让用户离开锚定页后仍知道自己在主体验哪一段，也能随时回到上次读到的卷宗。
