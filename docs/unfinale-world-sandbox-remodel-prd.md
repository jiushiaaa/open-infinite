...
- AppShell 当前任务条、世界工作区总览、世界脉搏条、世界位置条、体验轨道、全局续读与卷宗速览盘：所有世界内路由都会在顶栏下方显示“当前位置”、页面职责、主动作/次动作，并新增“当前环节 / 承接世界线 / 下一步为什么做”三枚纸面信息签，帮助用户跨页面时理解自己处在定界、运行、阅读还是采纳；这些信息签已升级为可点击世界旅程指针，当前环节回到对应旅程入口，承接世界线进入世界线档案，下一步说明直接执行主动作。工作区总览下方新增“当前任务”承接条，把“建议先做”、下一步理由、全局继续阅读、主动作和次动作放在同一纸面行里；移动端先显示任务理由，再用自适应紧凑动作保留继续阅读、主动作和次动作。任务条下方继续保留“记忆 / 代偿 / 正文 / 写作”四枚可点击世界脉搏信号，分别接回卷宗阅读、世界线档案、长线卷和作者采纳台，让用户持续看见这个世界的角色记忆、因果代偿、正文续读和下一章材料怎样延续。同一区域仍保留“定界 / 运行 / 阅读 / 采纳”四段可点击世界轨道。同一世界已有最近阅读记录时，位置条会在用户不在该阅读位置时提供“继续阅读”；位置条下方还提供“正文 / 正史 / 锚点 / 角色 / 势力 / 事件 / 长线 / 世界线”八个卷宗速览入口，让用户离开锚定页后仍知道自己在主体验哪一段，也能随时回到上次读到的卷宗或切换阅读对象；移动端已压缩壳层密度，390px/360px 下仍保留 9 个顶栏入口、当前任务条、4 个体验阶段、4 个世界脉搏和 8 个卷宗入口，不用牺牲功能换首屏。
