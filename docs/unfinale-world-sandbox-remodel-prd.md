...
- 世界沙盘页运行导览与首屏运行台：运行台已前置到沙盘页首屏，桌面在 hero 右侧、390px 移动端排在标题说明后和导览前；默认路径是先写大事件并立即启动一轮推演，读者干预、投放对象、投放方式和真实模型建议仍保留为可选项；导览层继续说明“投放事件 -> 观察角色 -> 进入阅读”，出结果后引导到卷宗阅读、世界线档案和多视角卷。
