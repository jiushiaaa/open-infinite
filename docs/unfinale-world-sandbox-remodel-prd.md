...
- AppShell 世界位置条、体验轨道、全局续读与卷宗速览盘：所有世界内路由都会在顶栏下方显示“当前位置”、页面职责、主动作/次动作，以及“定界 / 运行 / 阅读 / 采纳”四段可点击世界轨道；同一世界已有最近阅读记录时，位置条会在用户不在该阅读位置时提供“继续阅读”；位置条下方还提供“正文 / 正史 / 锚点 / 角色 / 势力 / 事件 / 长线 / 世界线”八个卷宗速览入口，让用户离开锚定页后仍知道自己在主体验哪一段，也能随时回到上次读到的卷宗或切换阅读对象；移动端已压缩壳层密度，390px/360px 下仍保留 9 个顶栏入口、4 个体验阶段和 8 个卷宗入口，不用牺牲功能换首屏。
