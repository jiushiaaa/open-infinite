...
| 阅读入口产品化 | `dossier-reading`、卷宗阅读页、卷首题签、连续阅读分场景、正文证据锚点、误会图谱、阅读进度书签、角色个人卷独立页、势力卷独立页、事件多视角详情页、跨事件长线卷、移动端先读正文、`readable_entry`、世界线/检查点/角色/事件/长线跳转和检查点醒来回放中枢已完成第一版 | 继续做跨章误会关系、长线阅读进度、多事件索引深化和跨章节回收 |
| 作者链路产品化 | Reviewer 片段级建议 -> 作者勾选采纳 -> `edited_final_chapter` -> 确认入卷 -> 下一轮入口已完成第一版；作者采纳台首屏已有四步工作流中枢和下一步主行动 | 继续做整章风格润色、可回滚对照、真实模型编辑器 |
| 世界入口与导航第一版 | 世界书架、导入/创世开卷中枢、顶栏世界内卷宗导航、锚定到天命书、天命书首屏宪法封面、世界线首屏工作流中枢、检查点首屏醒来回放中枢、多视角首屏工作流中枢、机制档案首屏中枢、沙盘空态导引、机制档案降噪、入口首屏 QA、世界内导览层 `WorldRunway`、锚定页启动卡、世界卷宗总览、角色个人卷独立页、势力卷独立页、事件多视角详情页、沙盘运行导览、移动端世界卷宗导航盘和移动端栏目保功能已完成第一轮 | 继续做更完整的 `WorldWorkspaceShell`、跨页面视觉 QA 和状态提示 |
...
2. **长正文与连续阅读质量**
   ...
   - 下一步做更自然的长文节奏、跨章误会回收、跨章伏笔回收、长线阅读进度、多事件索引深化和真实文风稳定。
...
5. **世界内部卷宗壳**
   - 已有世界线页、检查点首屏醒来回放中枢、卷宗阅读页、角色个人卷独立页、势力卷独立页、事件多视角详情页、跨事件长线卷、世界沙盘页、天命书首屏宪法封面、顶栏世界内卷宗导航、锚定页世界卷宗总览和 `WorldRunway` 导览层第一版。
   - 下一步做 `WorldWorkspaceShell`、跨章角色/势力长线阅读、多事件索引深化和更完整的机制档案分区，把旧工程面板继续收纳为支撑层。
