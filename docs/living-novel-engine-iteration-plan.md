...
**测试基线**：`cd engine && python -m pytest -q` → **612 passed**（截至 2026-05-31，v0.9.0-alpha Requirements UI Display 子刀后完整回归通过）；`cd engine/ui && pnpm run build` 通过。
