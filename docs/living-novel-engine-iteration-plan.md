...
| 阅读入口产品化 | `dossier-reading`、卷宗阅读页、卷首题签、连续阅读分场景、正文证据锚点、阅读进度书签、移动端先读正文、`readable_entry`、世界线/检查点/角色/事件跳转和检查点醒来回放中枢已完成第一版 | 继续做误会图谱、长线阅读进度、独立角色/势力卷 |
...
2. **长正文与连续阅读质量**
   ...
   - 下一步做更自然的长文节奏、误会图谱、跨章伏笔回收、长线阅读进度和真实文风稳定。
