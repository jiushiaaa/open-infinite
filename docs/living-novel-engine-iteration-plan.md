...
| 世界入口与导航第一版 | 世界书架、推荐世界面板、推荐世界续行台、故事卡下一步导览、导入/创世开卷中枢、顶栏世界内卷宗导航、`WorldWorkspaceShell` 旅程总线与状态预告、AppShell 当前任务条/世界工作区总览/世界脉搏条/世界位置条/世界体验轨道/全局续读入口/卷宗速览盘/世界旅程指针/移动端壳层压缩、锚定到天命书、天命书首屏宪法封面、天命书移动端宪法速断条、世界线首屏工作流中枢、世界线移动端承接导读条、世界线状态接力台、检查点首屏醒来回放中枢、检查点回放“读报告 / 查证据”模式切换、检查点回放移动端醒来导读条、检查点醒来接力台、多视角首屏工作流中枢、多视角移动端分镜导读条、机制档案首屏中枢、机制档案移动端导读条、沙盘空态导引、沙盘运行台分步化与首屏前置、沙盘“本轮已发生”结果承接台、沙盘策略棋盘、沙盘后续可能性回填下一轮、世界自演昨夜醒来台、机制档案降噪、入口首屏 QA、世界内导览层 `WorldRunway` 下一步承接层、锚定页启动卡、最近阅读续航、世界状态条、世界卷宗总览、世界脉搏、当前旅程状态、角色个人卷独立页、角色个人卷移动端导读条、角色个人卷记忆接力台、势力卷独立页、势力卷移动端导读条、势力卷压力接力台、事件多视角详情页、事件多视角移动端导读条、事件多视角信息差接力台、长线卷移动端导读条、长线卷跨章回收台、沙盘运行导览、移动端世界卷宗导航盘和移动端栏目保功能已完成第一轮 | 继续做跨页面视觉 QA、真实世界状态长期化和状态长期承接 |
