...
5. **世界内部卷宗壳**
   - 已有世界线页、检查点首屏醒来回放中枢、卷宗阅读页、角色个人卷独立页、势力卷独立页、事件多视角详情页、跨事件长线卷、世界沙盘页运行导览与运行台分步化、天命书首屏宪法封面、顶栏世界内卷宗导航、AppShell 世界位置条/世界体验轨道/全局续读入口/卷宗速览盘/移动端壳层压缩、锚定页世界卷宗总览/世界脉搏/当前旅程状态和 `WorldRunway` 导览层第一版。
