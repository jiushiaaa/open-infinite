...
| 阅读入口产品化 | `dossier-reading`、卷宗阅读页、卷首题签、连续阅读分场景、正文证据锚点、误会图谱、阅读进度书签、角色个人卷独立页、势力卷独立页、事件多视角详情页、移动端先读正文、`readable_entry`、世界线/检查点/角色/事件跳转和检查点醒来回放中枢已完成第一版 | 继续做跨章误会关系、长线阅读进度和跨事件长线阅读 |
...
2. **长正文与连续阅读质量**
   ...
   - 下一步做更自然的长文节奏、跨章误会回收、跨章伏笔回收、长线阅读进度和真实文风稳定。
...
5. **世界内部卷宗壳**
   - 已有世界线页、检查点首屏醒来回放中枢、卷宗阅读页、角色个人卷独立页、势力卷独立页、事件多视角详情页、世界沙盘页、天命书首屏宪法封面、顶栏世界内卷宗导航、锚定页世界卷宗总览和 `WorldRunway` 导览层第一版。
   - 下一步做 `WorldWorkspaceShell`、跨章角色/势力长线阅读、跨事件长线阅读和更完整的机制档案分区，把旧工程面板继续收纳为支撑层。
