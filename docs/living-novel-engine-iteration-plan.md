...
| 阅读入口产品化 | `dossier-reading`、卷宗阅读页、“读小说 / 查卷宗”模式切换、移动端导读条、卷宗阅读余波承接台、卷首题签、连续阅读分场景、本卷场景横向阅读轨道、当前场景导读条、正文证据锚点、误会图谱、阅读进度书签、角色个人卷独立页、角色个人卷移动端导读条、势力卷独立页、势力卷移动端导读条、事件多视角详情页、事件多视角移动端导读条、多视角移动端分镜导读条、跨事件长线卷、长线卷移动端导读条、长线卷跨章回收台、世界线移动端承接导读条、世界线状态接力台、检查点回放移动端醒来导读条、长线阅读进度、多事件索引、误会回收台、本机最近阅读续航、AppShell 全局续读入口与卷宗速览盘、移动端壳层压缩、未解线索、移动端先读正文、`readable_entry`、世界线/检查点/角色/事件/长线跳转和检查点醒来回放中枢已完成第一版 | 继续做更深跨章误会网络、账号级用户阅读进度持久化和跨章节回收 |
...
| 世界入口与导航第一版 | 世界书架、推荐世界面板、推荐世界续行台、故事卡下一步导览、导入/创世开卷中枢、顶栏世界内卷宗导航、`WorldWorkspaceShell` 旅程总线与状态预告、AppShell 当前任务条/世界工作区总览/世界脉搏条/世界位置条/世界体验轨道/全局续读入口/卷宗速览盘/世界旅程指针/移动端壳层压缩、锚定到天命书、天命书首屏宪法封面、天命书移动端宪法速断条、世界线首屏工作流中枢、世界线移动端承接导读条、世界线状态接力台、检查点首屏醒来回放中枢、检查点回放“读报告 / 查证据”模式切换、检查点回放移动端醒来导读条、多视角首屏工作流中枢、多视角移动端分镜导读条、机制档案首屏中枢、机制档案移动端导读条、沙盘空态导引、沙盘运行台分步化与首屏前置、沙盘“本轮已发生”结果承接台、沙盘策略棋盘、沙盘后续可能性回填下一轮、机制档案降噪、入口首屏 QA、世界内导览层 `WorldRunway` 下一步承接层、锚定页启动卡、最近阅读续航、世界状态条、世界卷宗总览、世界脉搏、当前旅程状态、角色个人卷独立页、角色个人卷移动端导读条、势力卷独立页、势力卷移动端导读条、事件多视角详情页、事件多视角移动端导读条、长线卷移动端导读条、长线卷跨章回收台、沙盘运行导览、移动端世界卷宗导航盘和移动端栏目保功能已完成第一轮 | 继续做跨页面视觉 QA、真实世界状态长期化和状态长期承接 |
