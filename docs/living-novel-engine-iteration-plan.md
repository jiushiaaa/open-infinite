...
| v0.9.1-v0.9.4 | Provider/Cost、MasterSetting、Graph Memory、Advanced Runner | 真实使用压力增强 | v0.9.1 已整体收口；下一步 v0.9.2 MasterSetting Lite，后续按召回和 runner 复杂度触发，不提前重依赖。 |
...
| P9.2 | v0.9.2 MasterSetting Workspace Lite | 项目级世界设定、人物、时间线、道具、伏笔、章节摘要的只读/轻编辑工作台 | 官方下一刀 |
