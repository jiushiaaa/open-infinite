...
2. **长正文与连续阅读质量**
   - 已有 `continuous_reading_chapter` v2、卷宗阅读页、“读小说 / 查卷宗”模式切换、卷首题签、本卷场景横向阅读轨道、余波承接台、确认稿阅读链、自演可读入口和世界自演昨夜醒来台。
