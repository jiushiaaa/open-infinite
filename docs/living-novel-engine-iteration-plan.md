...
| 阅读入口产品化 | `dossier-reading`、卷宗阅读页、卷首题签、连续阅读分场景、正文证据锚点、误会图谱、阅读进度书签、角色个人卷独立页、势力卷独立页、事件多视角详情页、跨事件长线卷、长线阅读进度、多事件索引、未解线索、移动端先读正文、`readable_entry`、世界线/检查点/角色/事件/长线跳转和检查点醒来回放中枢已完成第一版 | 继续做跨章误会关系、用户阅读进度持久化和跨章节回收 |
...
2. **长正文与连续阅读质量**
   ...
   - 下一步做更自然的长文节奏、跨章误会回收、跨章伏笔回收、用户阅读进度持久化和真实文风稳定。
