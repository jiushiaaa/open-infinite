...
| v0.9.1-v0.9.4 | Provider/Cost、MasterSetting Lite、Graph Memory Spike、Advanced Runner Spike | 真实使用压力增强 | v0.9.1、v0.9.2 与 v0.9.3 已整体收口；下一步 v0.9.4 先复核 runner 复杂度触发条件，不提前引入重依赖。 |
...
- v0.9.0-alpha 已整体收口，长篇共创形成 alpha 产品闭环；v0.9.1 provider/cost、v0.9.2 MasterSetting Lite 与 v0.9.3 Graph Memory Evaluation 已整体收口，但仍需 v0.9.4 与 v1.0-beta 才能接近商业级。
