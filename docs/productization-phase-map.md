...
| v0.9.1-v0.9.4 | Provider/Cost、MasterSetting Lite、Graph Memory Spike、Advanced Runner Spike | 真实使用压力增强 | v0.9.1 已整体收口；v0.9.2 Summary-A/Panel-B 已收口，后续最小轻编辑，再按长篇召回、设定管理、runner 复杂度触发增强，不提前引入重依赖。 |
