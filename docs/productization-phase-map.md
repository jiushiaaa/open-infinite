...
| v0.9.1-v0.9.4 | Provider/Cost、MasterSetting Lite、Graph Memory Spike、Advanced Runner Spike | 真实使用压力增强 | v0.9.1、v0.9.2 与 v0.9.3 已整体收口；v0.9.4 Trigger-A 已完成，下一步 Probe-B，不提前引入重依赖。 |
...
- v0.9.0-alpha 已整体收口，长篇共创形成 alpha 产品闭环；v0.9.1 provider/cost、v0.9.2 MasterSetting Lite 与 v0.9.3 Graph Memory Evaluation 已整体收口，v0.9.4 已进入高级 runner 触发式评估，但仍需 v0.9.4 收口与 v1.0-beta 才能接近商业级。
