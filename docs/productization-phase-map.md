...
Living Novel Engine 已完成 **短中篇可交互产品化 MVP**，并完成了 **长篇记忆与机制底座 MVP**。接下来的 v0.8.6-v0.8.10 不是推翻重做，而是把长篇底座收束成普通用户可理解、可上传、可复盘、可继续创作的产品工作流；v0.9.0-alpha 完成后，才算长篇共创产品闭环正式成立。
