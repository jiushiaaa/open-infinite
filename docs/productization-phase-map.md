...
| v0.9.1-v0.9.4 | Provider/Cost、MasterSetting Lite、Graph Memory Spike、Advanced Runner Spike | 真实使用压力增强 | v0.9.1 进行中：provider 摘要与 usage 聚合已收口；后续按成本、长篇召回、设定管理、runner 复杂度触发增强，不提前引入重依赖。 |
