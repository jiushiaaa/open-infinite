...
| v0.9.2 | MasterSetting Workspace Lite | 项目级世界设定、人物、时间线、道具、伏笔、章节摘要的只读/轻编辑工作台 | 进行中：Summary-A/Panel-B/Edit-C/Frontend-D 已收口，项目工作台已展示设定、人物、时间线、伏笔和章节摘要，并支持 `master_setting.yaml` 白名单后端保存与前端最小写控件；后续收口复核 |
