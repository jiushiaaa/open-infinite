...
| v0.9.1 | Provider & Cost Gateway Lite | 多 provider 配置、模型路由、成本/用量估算、失败回退、Key 脱敏展示 | 进行中：provider 摘要与 usage 聚合已收口，后续继续路由/价格配置或前端可视化；不默认接 Zep / 图数据库 / OASIS / CAMEL / LangGraph |
