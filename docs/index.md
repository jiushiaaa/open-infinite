...
| 产品愿景 | `unfinale-product-vision-correction-draft.md`、`living-novel-engine-prd.md` | 愿景、用户场景、产品结构；执行细节以当前主线 PRD 为准 |
...
| `living-novel-engine-prd.md` | 主 PRD | 产品定位、用户流程、核心概念；保留长期愿景，不替代当前路线 |
