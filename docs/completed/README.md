...
> 2026-06-08 整理补充：`docs/` 根目录只保留当前活文档；迁移说明、阶段归类和支撑层增强索引已进入本目录。S1-S9、卷宗阅读、自演可读入口、Reviewer 局部重写采纳和编辑后定稿仍在 `../../memory.md`、`../unfinale-world-sandbox-remodel-prd.md`、`../living-novel-engine-iteration-plan.md`、`../unfinale-current-optimization-backlog.md`、`../../engine/README.md` 与 `../history/project-changelog.md` 中维护。
...
- 当前后续优化：`../unfinale-current-optimization-backlog.md`
...
| 文档治理 | `codex-migration-guide.md`、`productization-phase-map.md`、`support-layer-enhancement-index.md` | Codex 迁移说明、阶段归类和支撑层索引；均已从 docs 根目录移出 |
...
当前世界沙盘 S1-S9、卷宗阅读页、自演结果可读入口、Reviewer 局部重写采纳、编辑后定稿等主线产物仍在根层 PRD、`memory.md`、`engine/README.md`、`../unfinale-current-optimization-backlog.md` 和 `../history/project-changelog.md` 里维护；这些不是 `completed/` 的默认读取入口。
