...
| 世界内导航语境 | `AppShell` 已在所有世界内路由下方显示“当前位置”纸面条，按锚定、天命书、沙盘、阅读、长线卷、角色卷、势力卷、事件卷、世界线、检查点、多视角、作者台和机制档案说明页面职责；同时提供“当前环节 / 承接世界线 / 下一步为什么做”世界工作区总览、“当前任务”承接条、“记忆 / 代偿 / 正文 / 写作”世界脉搏条、“定界 / 运行 / 阅读 / 采纳”世界体验轨道、全局“继续阅读”、主动作/次动作，以及“正文 / 正史 / 锚点 / 角色 / 势力 / 事件 / 长线 / 世界线”卷宗速览盘；三枚世界工作区总览信息签已是可点击旅程指针，当前任务条把“建议先做”、下一步理由、继续阅读、主动作和次动作放在同一纸面行，四枚世界脉搏信号可分别回到卷宗阅读、世界线档案、长线卷和作者采纳台；移动端壳层已压缩，390px/360px 下 9 个顶栏入口、当前任务条、4 个脉搏、4 个阶段和 8 个卷宗入口均保留且无水平溢出 | 更完整 `WorldWorkspaceShell`、跨页面视觉 QA |
