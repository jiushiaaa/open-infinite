...
| v0.9.2 | MasterSetting Workspace Lite：项目级设定/人物/时间线/道具/伏笔/章节摘要工作台 | 进行中：Summary-A/Panel-B/Edit-C/Frontend-D 已收口 |
...
**测试基线**：`pytest -q` → **632 passed**（2026-06-01，v0.9.2 MasterSetting Workspace Frontend-D 后完整回归通过）；`engine/ui` 执行 `pnpm run build` 通过。
...
| v0.9.1-v0.9.4 | provider/cost、MasterSetting Lite、Graph Memory spike、Advanced Runner spike（v0.9.2 Summary-A/Panel-B/Edit-C/Frontend-D 已收口，后续收口复核） |
