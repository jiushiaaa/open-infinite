...
| 世界内导航语境 | `AppShell` 已在所有世界内路由下方显示“当前位置”纸面条，按锚定、天命书、沙盘、阅读、长线卷、角色卷、势力卷、事件卷、世界线、检查点、多视角、作者台和机制档案说明页面职责；同时提供“定界 / 运行 / 阅读 / 采纳”世界体验轨道、全局“继续阅读”、主动作/次动作，以及“正文 / 正史 / 锚点 / 角色 / 势力 / 事件 / 长线 / 世界线”卷宗速览盘 | 更完整 `WorldWorkspaceShell`、跨页面视觉 QA |
