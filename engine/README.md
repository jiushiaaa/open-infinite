...
**测试基线**：`pytest -q` → **638 passed**（2026-06-01，v0.9.3 Graph Memory Evaluation Spike 收口后完整回归通过）；`engine/ui` 执行 `pnpm run build` 通过。
...
| v0.9.1-v0.9.4 | provider/cost、MasterSetting Lite、Graph Memory spike、Advanced Runner spike（v0.9.3 已整体收口，下一步 v0.9.4 触发条件复核） |
