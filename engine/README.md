...
| 真实 LLM 策略建议 | `llm_decision_mode=advisory` 会写 `agent_decision_advisory.json`，展示采信、欺骗、传播、反抗、临场判断、策略博弈读法、暗线续推判断、关系势力发酵和策略棋盘 | 多轮策略规划、长期关系/势力博弈 |
