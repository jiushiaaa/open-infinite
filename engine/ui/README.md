...
| `DossierReadingPage` | 世界内部卷宗阅读页，默认连续阅读；卷首题签说明当前阅读卷、偏差/悬念、证据数和下一步行动，连续正文按场景展示阅读进度、认知偏差、冲突转折和段内证据锚点，可切换世界正史卷、主锚点卷、角色个人卷、事件多视角和确认正文 |
...
- `ImportNovelPage`、`GenesisPage`、`DossierReadingPage`、世界自演可读入口、天命书页、世界线页、检查点页、多视角页、机制档案页和作者采纳台已完成第一版首屏理解切片；卷宗阅读正文证据锚点和阅读进度也已完成第一版；但仍需误会图谱、长正文文风、整章风格润色和更强真实语义 Reviewer。
