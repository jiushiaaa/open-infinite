...
- 世界入口第一轮已经把故事书架、天命书、世界沙盘、卷宗阅读、世界线、多视角和作者台串成世界内卷宗导航；首屏 QA 已覆盖浏览器标题、无天命书空态和真实 390px 移动端入口换行；移动端顶栏已把世界内部导航改为可换行卷宗盘，锚定、天命书、沙盘、阅读、世界线、多视角、作者台和机制档案全部直接可见；天命书页已新增首屏宪法封面，前置生成、确认、干预预编译和进入沙盘；世界线页、检查点页和多视角页已新增首屏工作流中枢，分别前置分支承接/沙盘续行、醒来回放/连续阅读和生成多视角/阅读信息差/作者台出口；世界内导览层 `WorldRunway` 已在世界沙盘、卷宗阅读、世界线档案、检查点回放和作者采纳台中统一“当前位置 -> 理解路径 -> 下一步行动”；作者采纳台已新增首屏工作流中枢，前置对照、入账、修订、入卷状态和下一步行动；世界锚定页已把天命书、沙盘和卷宗阅读前置为“世界启动”行动卡，移动端不再隐藏锚定侧栏或角色栏；`WorkspacePage.tsx` 现在按“世界正史与机制档案”理解，用于收纳旧正史、机制解释和支撑层入口。
...
| `TianmingPage` | 天命书页，首屏宪法封面展示生成/确认/干预预编译/进入沙盘四步、当前锚点、合约压力和摘要统计；保留吸引子、锚点、压力、候选承载者、干预边界、干预预编译和世界线代偿 |
| `WorldSandboxPage` | 世界沙盘、运行导览、干预投放、真实 LLM 决策 advisory、世界自演结果和阅读出口 |
| `WorldlineDossierPage` | 世界线档案，首屏工作流中枢展示分支状态、因果债、检查点、自演任务、代偿域和下一步动作；保留世界线状态、自演任务、检查点与可读入口 |
| `CheckpointReplayPage` | 检查点回放，首屏醒来回放中枢前置大事件、角色记忆、因果代偿和连续阅读出口；保留状态变化、记忆变化、具象代偿和后续可写方向 |
| `DossierReadingPage` | 世界内部卷宗阅读页，默认连续阅读；卷首题签说明当前阅读卷、偏差/悬念、证据数和下一步行动，可切换世界正史卷、主锚点卷、角色个人卷、事件多视角和确认正文 |
...
- `#/world/<slug>/lens`：多视角活体小说，生成事件多视角并进入卷宗阅读或作者采纳台。
...
- `DossierReadingPage`、世界自演可读入口、天命书页、世界线页、检查点页、多视角页和作者采纳台已完成第一版，卷宗阅读页已补卷首题签和移动端先读正文布局，天命书页已补首屏宪法封面，世界线页、检查点页、多视角页和作者采纳台已补首屏工作流中枢；但仍需正文内证据锚点、误会图谱、长正文文风、整章风格润色和更强真实语义 Reviewer。
