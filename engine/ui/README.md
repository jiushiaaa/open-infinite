...
| `WorldAnchorPage` | 世界锚定、设定确认、视觉/审计/角色校准、“世界启动”行动卡、最近阅读续航和世界卷宗总览；移动端在启动卡后前置卷宗地图，并保留左栏与角色栏功能 |
