...
const requiredPageMarkers = [
  ...
  ["strategyGameReadout", "strategy game readout should derive a readable result ledger from the API"],
  ["sandbox-strategy-readout", "strategy game readout should sit before the dense strategy board"],
  ["策略博弈结果总览", "strategy game readout should name the readable result surface"],
  ["谁在隐瞒", "strategy game readout should expose concealment"],
  ["谁在试探", "strategy game readout should expose probing"],
  ["谁在误判", "strategy game readout should expose misreads"],
  ["谁在欺骗", "strategy game readout should expose deception"],
  ["谁在临场改判", "strategy game readout should expose situational pivots"],
  ["为什么会这样", "strategy game readout should explain motivation"],
  ["这一步改变了什么", "strategy game readout should explain concrete changes"],
  ["事件", "strategy game readout should include event changes"],
  ["记忆", "strategy game readout should include memory changes"],
  ["传播", "strategy game readout should include propagation changes"],
  ["代偿", "strategy game readout should include compensation changes"],
  ["章节素材", "strategy game readout should include chapter material changes"],
...
const requiredCssMarkers = [
  ...
  [".sandbox-strategy-readout", "strategy game readout styling is missing"],
  [".sandbox-strategy-readout__grid", "strategy game readout grid styling is missing"],
  [".sandbox-strategy-readout-card", "strategy game readout card styling is missing"],
  [".sandbox-strategy-readout-card__moves", "strategy game readout move tags styling is missing"],
  [".sandbox-strategy-readout-card__changed", "strategy game readout change ledger styling is missing"],
