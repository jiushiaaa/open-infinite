...
def _endpoints() -> list[dict[str, Any]]:
    return [
        ...
        _endpoint(
            "stories",
            "POST",
            "/api/stories/{slug}/vector-retrieval/index",
            "构建真实向量检索索引",
            "buildVectorRetrievalIndex",
            "VectorRetrievalIndexReport",
            client_method="buildVectorRetrievalIndex",
            status_codes=[200, 400, 404],
        ),
        _endpoint(
            "stories",
            "POST",
            "/api/stories/{slug}/vector-retrieval/search",
            "预览混合向量检索与重排结果",
            "searchVectorRetrieval",
            "VectorRetrievalSearchReport",
            client_method="searchVectorRetrieval",
            status_codes=[200, 400, 404],
        ),
        _endpoint(
            "stories",
        ...
        _endpoint(
            ...
            "读取 Graph 记忆 provider spike opt-in 配置草案",
            "getGraphMemoryProviderSpikeOptInConfigDraft",
            "GraphMemoryProviderSpikeOptInConfigDraftReport",
            client_method="getGraphMemoryProviderSpikeOptInConfigDraft",
            status_codes=[200, 400, 404],
        ),
        _endpoint(
            "stories",
            ...
            "读取 Graph 记忆 provider spike 本地 provider contract 与 adapter 边界",
            "getGraphMemoryProviderSpikeLocalProviderContract",
            "GraphMemoryProviderSpikeLocalProviderContractReport",
            client_method="getGraphMemoryProviderSpikeLocalProviderContract",
            status_codes=[200, 400, 404],
        ),
        _endpoint(
            "stories",
            ...
            "读取 Graph 记忆 provider spike 单 fixture dry-run harness",
            "getGraphMemoryProviderSpikeSingleFixtureDryRunHarness",
            "GraphMemoryProviderSpikeSingleFixtureDryRunHarnessReport",
            client_method="getGraphMemoryProviderSpikeSingleFixtureDryRunHarness",
            status_codes=[200, 400, 404],
        ),
        _endpoint(
            "stories",
            ...
            "读取 Graph 记忆 provider spike mock-compatible adapter 规格",
            "getGraphMemoryProviderSpikeMockCompatibleAdapter",
            "GraphMemoryProviderSpikeMockCompatibleAdapterReport",
            client_method="getGraphMemoryProviderSpikeMockCompatibleAdapter",
            status_codes=[200, 400, 404],
        ),
        _endpoint(
            "stories",
            ...
            "读取 Graph 记忆 provider spike mock adapter 人工复核包",
            "getGraphMemoryProviderSpikeManualMockAdapterReview",
            "GraphMemoryProviderSpikeManualMockAdapterReviewReport",
            client_method="getGraphMemoryProviderSpikeManualMockAdapterReview",
            status_codes=[200, 400, 404],
        ),
        _endpoint(
            "stories",
        ...
        _endpoint(
            ...
            client_method="getRetrievalProviderConfiguration",
            status_codes=[200],
        ),
        _endpoint(
            "settings",
            ...
            "测试检索增强 provider 连接",
            "postRetrievalProviderTest",
            "RetrievalProviderConnectivityResult",
            client_method="testRetrievalProviderConnectivity",
            status_codes=[200],
        ),
        _endpoint(
            "settings",
